...
![](t8_diagnostic_plots_files/figure-gfm/plot-famhex-1.png)<!-- -->

``` r
famhexplot_samplefacet <- grid.arrange(plot_fam(axxin, mycolumn="category"), plot_hex(axxin, mycolumn="category"), nrow=2)
```

![](t8_diagnostic_plots_files/figure-gfm/plot-famhex-2.png)<!-- -->
...
![](t8_diagnostic_plots_files/figure-gfm/plot-multiplex-1.png)<!-- -->
...
![](t8_diagnostic_plots_files/figure-gfm/plot-time2sig-1.png)<!-- -->
